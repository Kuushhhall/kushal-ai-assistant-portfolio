  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'kushalpugalia15@gmail.com',
      href: 'mailto:kushalpugalia15@gmail.com',
      color: 'text-blue-600'
    },
    {
    ...
    },
    {
      ...
      title: 'LinkedIn',
      value: 'kuushhhall',
      href: 'https://www.linkedin.com/in/kuushhhall/',
      color: 'text-blue-700'
    },
    {
      ...
      title: 'GitHub',
      value: 'Kuushhhall',
      href: 'https://github.com/Kuushhhall',
      color: 'text-gray-800'
    },
    {
      ...
      title: 'Instagram',
      value: 'kuushhhall',
      href: 'https://www.instagram.com/kuushhhall/',
      color: 'text-pink-600'
    }
  ];
      ...
      <div className="text-center space-y-4 pt-6">
        <div className="bg-accent rounded-lg p-6">
          ...
          <p className="text-sm text-muted-foreground">
            • Data Science & AI opportunities • Machine Learning projects with real-world impact • Full-stack development roles •
